...
class ATMS(nn.Module):    
    def __init__(self, num_channels=63, sequence_length=250, num_subjects=10, num_features=64, num_latents=1024, num_blocks=1):
        ...
        self.encoder = iTransformer(default_config, num_subjects=num_subjects)   
...
def main():
    ...
    for sub in subjects:
        ...
        print('insubject: ',args.insubject)
        if args.insubject:
            print("--- Running in IN-SUBJECT mode ---")
            ...
            print("--- Running in CROSS-SUBJECT mode ---")
