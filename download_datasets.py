...
snapshot_download(
    ...
    allow_patterns=["ViT-H-14_features_train.pt", "ViT-H-14_features_test.pt", "Preprocessed_data_250Hz/sub-08/preprocessed_eeg_test.npy", "Preprocessed_data_250Hz/sub-08/preprocessed_eeg_training.npy"]
)
